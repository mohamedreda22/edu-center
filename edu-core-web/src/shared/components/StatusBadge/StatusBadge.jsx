...
const domainConfig = {
  ...
  lesson: {
    SCHEDULED: 'bg-blue-50 text-blue-700 border border-blue-200 hover:bg-blue-100',
    ...
    NO_SHOW: 'bg-gray-50 text-gray-700 border border-gray-200 hover:bg-gray-100',
  },
  payment: {
    PENDING: 'bg-yellow-50 text-yellow-700 border border-yellow-200 hover:bg-yellow-100',
    PARTIALLY_PAID: 'bg-orange-50 text-orange-700 border border-orange-200 hover:bg-orange-100',
    ...
    CANCELLED: 'bg-gray-50 text-gray-700 border border-gray-200 hover:bg-gray-100',
  },
};
...
const StatusBadge = ({ status, domain, className }) => {
  const variantClass =
    domainConfig[domain]?.[status] || 'bg-gray-100 text-gray-800 border-gray-200';
